...
function drawChart(data) {
    ...
    node_header.on("mouseover", function (evt) {
        showTooltip(evt.descr, evt);
    })
    node_header.on("mouseleave", function (evt) {
        showTooltip(null, evt);
    })
    ...
    var ticked = function () {
        ...
        link
            .attr("d", function (d) {
                ...
                var t_mov_y = d.target.fixed_y < d.source.fixed_y ? -.55 : 0
                var s_mov_x = d.source.fixed_x < d.target.fixed_x ? -.52 : .52
                var a = []
